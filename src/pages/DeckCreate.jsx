        ...
        <Layout>
            {
             ...
             subdecks.eden.message > 0 ?
                ...
                :
                <NavButton text="create eden" timing={1000} url={`/decks/${id}/eden`} onClick={handleClickNav} />
            }
            {
             ...
             subdecks.register.message > 0 ?
                ...
                :
                <NavButton text="create register" timing={1000} url={`/decks/${id}/register`} onClick={handleClickNav}/>
            }
            {
             ...
             subdecks.holybook.message > 0 ?
                ...
                :
                <NavButton text="create holybook" timing={1000} url={`/decks/${id}/holybook`} onClick={handleClickNav}/>
            }
        </Layout>
    )
}
