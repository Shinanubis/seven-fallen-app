            ...
            <Layout>
                <form className="form">
                    <div className="form--section">
                        ...
                        <InputText classes={inputState === true ? "form--input bad__input" : 'form--input good__input'} placeholder="Deck name" onChange={handleInputChange} onBlur={handleBlur} value={fieldValues.deck_name}/>
