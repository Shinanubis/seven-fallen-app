            ...
            <Layout>
                <form className="form">
                    <div className="form--section">
                        ...
                        <InputText classes={fieldValues.deck_name.length !== 0 ? "form--input" : "form--input bad__input"} placeholder="Nom du deck" onChange={handleInputChange} onBlur={handleBlur} value={fieldValues.deck_name}/>
