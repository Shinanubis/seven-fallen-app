            ...
            <ul ref={listRef} className={classesContainer ? classesContainer : "infinite__container"}  onLoad={handleImageLoading}>
                {
                    ...
                    datas.map((elmt, index) => {
                        return (
                                ...
                                >
                                    {console.log(imagesLoading['page__'+elmt.id])}
                                        <img 
                                            id={`page__${elmt.id}`}
                                            className={imagesLoading["page__"+elmt.id] === true ? "cards__image" : "d-none"} 
                                        ...
                                        <img 
                                            id={`loader__${elmt.id}`}
                                            className={imagesLoading["page__"+elmt.id] === false ? "cards__counter" : "d-none"}
                                            src={LoaderGif}  
                                        />
                                </li>
                            )
